...
"""
    jlmie_Enf1_n(nmat, radius, lbd0, nenv, r, theta, phi, n::Int=1)
...
function jlmie_Enf1_n(nmat, radius, lbd0, nenv, r, theta, phi, n::Int=1)
    ...
    k1 = 2π ./ lbd1  # free space wavenumber in the sphere
    x = k .* radius
    x1 = k1 .* radius
    mu = cos.(theta)
...
"""
    jlmie_Enfs_n(nmat, radius, lbd0, nenv, r, theta, phi, n::Int=1)
